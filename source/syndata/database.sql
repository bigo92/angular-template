...
ALTER TABLE DATA_DIODE_SYNC_NOTI_STAY_MERGE
ADD SYN_STATUS NUMBER AS (CASE WHEN PROCESS_STATUS IS NULL AND PROCESS_STATUS_REF IS NOT NULL AND PROCESS_STATUS_REF = 3 THEN 1
                               WHEN PROCESS_STATUS_REF IS NULL AND PROCESS_STATUS IS NOT NULL AND PROCESS_STATUS = 3 THEN 1
                               WHEN PROCESS_STATUS IS NOT NULL AND PROCESS_STATUS = 3 AND PROCESS_STATUS_REF IS NOT NULL AND PROCESS_STATUS_REF = 3 THEN 1
                          ELSE 0 END
);
-----------------------------------------------------
